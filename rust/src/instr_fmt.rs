...
const INSTR_TBL: &[InstrFmt] = &[
  ...
  InstrFmt {  op: Opcode::OP_IMUL,      op1: 0x69,     op2: -1,   oper: [Oper::OPER_R16,     Oper::OPER_RM16,    Oper::OPER_IMM16],     hidden: 0x0 },
  InstrFmt {  op: Opcode::OP_PUSH,      op1: 0x6a,     op2: -1,   oper: [Oper::OPER_IMM8,    Oper::OPER_NONE,    Oper::OPER_NONE],      hidden: 0x0 },
  InstrFmt {  op: Opcode::OP_IMUL,      op1: 0x6b,     op2: -1,   oper: [Oper::OPER_R16,     Oper::OPER_RM16,    Oper::OPER_IMM8],      hidden: 0x0 },
