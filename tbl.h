...
typedef struct instr_8086 instr_8086_t;
struct instr_8086
{
  int op;       /* OP_ */
  u8  opcode1;  /* 1st byte: opcode */
  u8  opcode2;  /* 3-bit modrm reg field: sometimes used as level 2 opcode */
  int operand1; /* OPER_ */
  int operand2; /* OPER_ */
  int operand3; /* OPER_ */
};

static instr_8086_t instrs[] = {
  // opname    opcode   opcode2   operand1       operand2       operand3
